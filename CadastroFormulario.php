...
if ($total == 0) {
    ...
    mysqli_query($conexao, "INSERT INTO fichas(cidade, data, isolamento, notificacao, pacientes, "
                    ...
                    . "regiao_adm) VALUES ('$_POST[cidade]', '$_POST[data]',"
                    ...
                    . "'$_POST[internados_uti]','$_POST[fila_internacao]','$_POST[regiao_adm]')") or die("Houve um erro inespesrado durante o processo");
    ...
    mysqli_query($conexao, "UPDATE fichas SET cidade = '$_POST[cidade]', data = '$_POST[data]', isolamento = '$_POST[isoladas]' "
            ...
            . "positivo_saude = '$_POST[prof_saude_positivo]', obito_saude = '$_POST[prof_saude_obito]', leitos = '$_POST[leitos]',leitos_uti = '$_POST[leitos_uti]', internados_uti = '$_POST[internados_uti]', fila_intternacao = '$_POST[fila_internacao]', regiao_adm = '$_POST[regiao_adm]'"
